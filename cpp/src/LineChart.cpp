#include "../include/myNM_bits/LineChart.hpp"
#include "../include/myNM_bits/textFunctions.hpp"
...
LineChart::LineChart() : title("A LineChart")
{
}
...
static void testWriteLineChartData()
{
    ...
    string actual = s.str();
    string expected = string("") + "var data = google.visualization.arrayToDataTable([\n" + "['x values','y values'],\n" + "[0, 0],\n" + "[1, 1],\n" + "[2, 4]\n" + "]);\n";
    cout << actual;
    cout << expected;
